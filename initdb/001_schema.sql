...
CREATE TABLE students (
    ...
    CONSTRAINT fk_students_schools FOREIGN KEY (school_id) REFERENCES schools (school_id) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;

-- 部活（学習用に索引は最小限＝PK/FKのみ）
CREATE TABLE clubs (
    id VARCHAR(20) NOT NULL COMMENT 'ID',
    student_id VARCHAR(20) NOT NULL COMMENT '学籍番号',
    club_name VARCHAR(100) NOT NULL COMMENT '部活',
    PRIMARY KEY (id),
    CONSTRAINT fk_clubs_students FOREIGN KEY (student_id) REFERENCES students (student_id) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE scores (
    ...
    CONSTRAINT fk_scores_students FOREIGN KEY (student_id) REFERENCES students (student_id) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
